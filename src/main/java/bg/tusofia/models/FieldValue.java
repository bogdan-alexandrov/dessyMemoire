 ...
 *           &lt;element ref="{}vector"/>
 *         &lt;/choice>
 *         &lt;element name="dependent_on" type="{http://www.w3.org/2001/XMLSchema}anyType" maxOccurs="unbounded"/>
...
@XmlRootElement(name = "field_value")
public class FieldValue implements java.io.Serializable{
    ...
    @XmlElement(name = "dependent_on", required = true)
    protected List<Object> dependentOn;
     ...
     * This is why there is not a <CODE>set</CODE> method for the dependentOn property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDependentOn().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getDependentOn() {
        if (dependentOn == null) {
            dependentOn = new ArrayList<Object>();
        }
